...
### 📋 Prochaine session
- [x] ~~**PRIORITÉ** : Ajouter la durée de pause configurable (5/10/15 minutes) dans Settings~~ ✅
- [x] ~~**PRIORITÉ** : Ajouter bouton "+" dans la liste de passage oral pour insérer des pauses directement~~ ✅
