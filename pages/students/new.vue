...
async function handleSubmit() {
  ...
  try {
    const created = await studentsStore.addStudent({
      name: form.name.trim(),
...
<template>
  <div class="page">
    ...
    <div class="page-header">
      ...
      <h1 class="page-title">Nouvel élève</h1>
    </div>
    ...
    <form class="form-card" @submit.prevent="handleSubmit">
      ...
      <div class="form-actions">
        <UButton to="/" variant="ghost" color="gray">Annuler</UButton>
        <UButton type="submit" :loading="loading" :disabled="!isValid" icon="i-heroicons-plus">
          Créer l'élève
        </UButton>
      </div>
    </form>
